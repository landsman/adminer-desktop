...
# One source for every string the native shell shows (menu, dialogs, downloads): the per-language
# files under app/src/I18n/Locale/, generated by Desktop\I18n\Generator into each platform's own
